...
$sql2="SELECT * FROM `tbl_payment` WHERE Plant_Num = '$P' and  P_Date >= '$df' and  P_Date<= '$dt' ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<table width="694" border="1" bgcolor="#0033FF">
    <tr>
      <td colspan="4"><div align="center" class="style1">REPORT OF PAYMENT</div></td>
    </tr>
    <tr>
      <td width="173" height="29"><div align="center"><strong class="style2">PLANT NUMBER </strong></div></td>
      <td width="156"><div align="center"><strong class="style2">DATE FROM </strong></div></td>
      <td width="200"><div align="center"><strong class="style2">DATE TO</strong></div></td>
      <td width="137">&nbsp;</td>
    </tr>
    <tr>
      <td><div align="center">
    ...
    <tr>
	 <td><div align="center"><span class="style7">Rec No.</span></div></td>
      <td><div align="center"><span class="style7">Amount Paid.</span></div></td>
      <td><div align="center"><span class="style7">Date</span></div></td>
      <td colspan="2"><div align="center"><span class="style7">Time</span></div></td>
    </tr>
	 ...
	 <?php while($rem2=mysql_fetch_array($res2))
               ...
               <td colspan="2"><span class="style10"><?php echo $rem2[5]?></span></td>
			   </tr>
	      <?php }?>
