...
$sql3="select max(p_id) from tbl_payment" ;
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="PlantPay2.php" enctype="multipart/form-data">
    ...
    <tr>
      <td><div align="center"><strong>Amount Collected </strong></div></td>
      <td><div align="center">
