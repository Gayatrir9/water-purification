...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="compview12.php" enctype="multipart/form-data">
			<table width="514" height="124" border="1" bgcolor="#0033FF">
    <tr>
      <td colspan="2"><div align="center" class="style1">COMPLAINT STATUS VIEW </div></td>
    </tr>
    <tr>
