...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="payview12.php" enctype="multipart/form-data">
			<table width="578" height="172" border="1" bgcolor="#0033FF">
    <tr>
      <td colspan="2"><div align="center" class="style1">PAYMENT VIEW </div></td>
    </tr>
    <tr>
      <td width="229" height="66"><p align="center" class="style2">FORM</p>
      <p align="center">
      ...
      <td width="204"><p align="center" class="style2"><strong>TO</strong></p>
      <p align="center">
    ...
    <tr>
      <td colspan="2"><div align="center"><strong class="style2">PLANT ID</strong>
