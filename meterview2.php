...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="meterview12.php" enctype="multipart/form-data">
			 <table width="496" height="145" border="1" bgcolor="#FFFFFF">
    <tr>
      <td colspan="2"><div align="center" class="style1">METER READING VIEW </div></td>
    </tr>
    <tr>
      <td width="231"><p align="center" class="style4">FROM</p>
      ...
      <td width="249"><p align="center" class="style4"><strong>TO</strong></p>
    ...
    <tr>
      <td colspan="2"><div align="center" class="style5"><span class="style6">PLANT ID</span><strong>        
