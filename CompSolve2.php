...
$engname = $_POST['ENG'];
$status = $_POST['T5'];
$solveda = $_POST['se6'].'-'.$_POST['se5'].'-'.$_POST['se4'];
$Desc = $_POST['T3'];
//STR_TO_DATE("$atda","%d-%m-%Y")
$sql1="insert into comp_solved values('$solveid','$compid','$engname',STR_TO_DATE('$solveda','%Y-%m-%d'),'$status','$Desc')";
$res=mysql_query($sql1) or die(mysql_error());

if($res)
{
$sql44 =  "update complaint 
		   set status = 0
           where Complaint_Entry_Id = $compid ";
$res44 = mysql_query($sql44) or die(mysql_error());
