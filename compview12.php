...
<body>
    ...
    <tr>
      <td colspan="4"><div align="center" class="style1">REPORT OF COMPLAINT STATUS </div></td>
    </tr>
    <tr>
      <td width="138" height="29"><div align="center"><strong class="style2">PLANT NUMBER </strong></div></td>
      <td width="157"><div align="center"><strong class="style2">DATE FROM </strong></div></td>
      <td colspan="2"><div align="center"><strong class="style2">DATE TO</strong></div></td>
    </tr>
    <tr>
      <td><div align="center">
    ...
    <tr>
	 <td><div align="center"><span class="style7">Comp. ID</span></div></td>
      <td><div align="center"><span class="style7">Engeer</span></div></td>
	  <td width="331"><div align="center"><span class="style7">Comp Description</span></div></td>
      <td colspan="3"><div align="center"><span class="style7">Comp Date</span></div>        <div align="center"></div></td>
	 ...
	 <?php while($rem2=mysql_fetch_array($res2))
               ...
               <td colspan="3"><div align="center"><span class="style10"><?php echo $rem2[4]?></span></div>                 <div align="center"></div></td>
               <td width="69" colspan="2"><div align="center"><span class="style10"><?php echo $rem2[6]?></span></div></td>
			   </tr>
	      <?php }?>
