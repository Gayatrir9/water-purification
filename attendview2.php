...
$sql="select Emp_first_name from employee_information";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="attendview12.php" enctype="multipart/form-data">
			 <table width="546" height="170" border="1" bgcolor="#0033FF">
    <tr>
      <td colspan="2"><div align="center" class="style1">ATTENDENCE VIEW </div></td>
    </tr>
    <tr>
...
<select name="se2" id="se2">
      ...
      <td width="274"><p align="center" class="style3">TO</p>
        <p align="center">
    ...
    <tr>
      <td colspan="2"><div align="center"><span class="style3">EMPLOYEE</span>  
          <select name="se7" id="se7">
