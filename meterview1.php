...
$sql2="SELECT * FROM `tbl_meterreading` WHERE Plant_No = '$P' and  Meter_Date >= '$df' and  Meter_Date<= '$dt' ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<table width="694" border="1" bgcolor="#FFFFFF">
    <tr>
      <td colspan="4"><div align="center" class="style1 style11">REPORT OF PAYMENT</div></td>
    </tr>
    <tr>
      <td width="173" height="29"><div align="center" class="style11">PLANT NUMBER </div></td>
      <td width="156"><div align="center" class="style11">DATE FROM </div></td>
      <td width="200"><div align="center" class="style11">DATE TO</div></td>
      <td width="137"><span class="style11"></span></td>
    </tr>
    <tr>
    ...
    <tr>
	 <td><div align="center" class="style11"><span class="style12">Sl No.</span></div></td>
      <td><div align="center" class="style11"><span class="style12">RR No. Readimng.</span></div></td>
      <td><div align="center" class="style11"><span class="style12">WTR Met Reading.</span></div></td>
      <td colspan="2"><div align="center" class="style11"><span class="style12">Date Of Reading</span></div></td>
	  <td colspan="2"><div align="center" class="style11"><span class="style12">Time Of Reading</span></div></td>
    </tr>
    
	 <?php while($rem2=mysql_fetch_array($res2))
		        {?>
		  		<tr class="style2">
				<td><span class="style13"><?php echo $rem2[0]?></span></td>
               <td><span class="style13"><?php echo $rem2[3]?></span></td>
               <td><span class="style13"><?php echo $rem2[4]?></span></td>
               <td colspan="2"><span class="style13"><?php echo $rem2[5]?></span></td>
			   <td colspan="2"><span class="style13"><?php echo $rem2[6]?></span></td>
			   </tr>
	      <?php }?>
