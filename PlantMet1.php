...
$sql1="select * from employee_information ";
$res1=mysql_query($sql1) or die(mysql_error()); 
//$rem1=mysql_fetch_array($res1);

$sql3="select max(Meter_Entry_Id) from tbl_meterreading " ;
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="PlantMet2.php" enctype="multipart/form-data">
				  <table width="658" border="1">
    <tr>
      <td colspan="4"><div align="center" class="style2">Employee Attendance </div></td>
    </tr>
    <tr>
      <td width="198"><span class="style2">Auto Gen Id </span></td>
      <td width="141"><input name="T1" type="text" id="T1" value="<?php echo $num ?>" required ></td>
      <td width="110"><span class="style2">R.R.Number</span></td>
      <td width="181"><input name="T22" type="text" id="T22" value="<?php echo $rem[7] ?> "></td>
    </tr>
    <tr>
      <td height="34"><span class="style2">Plant Number </span></td>
      <td><input name="T2" type="text" id="T2" value="<?php echo $rem[0] ?> "></td>
      <td rowspan="2"><span class="style2">Plant Address </span></td>
      <td rowspan="2"><textarea name="T6" id="T6"><?php echo $rem[5] ?> </textarea></td>
    </tr>
    <tr>
      <td height="29">Meter Reader Name </td>
    ...
    <tr>
      <td><div align="center">Electric Meter </div></td>
      <td><div align="center">Water Meter </div></td>
      <td colspan="2"><div align="center">Date</div></td>
      </tr>
    <tr>
