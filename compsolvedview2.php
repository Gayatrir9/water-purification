...
$sql="select Plantnoo from plant_information";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="compsolvedview12.php" enctype="multipart/form-data">
			<table width="514" height="124" border="1" bgcolor="#0033FF">
    <tr>
      <td colspan="2"><div align="center" class="style1">COMPLAINT SOLVED INFO VIEW </div></td>
    </tr>
    <tr>
      <td width="256"><p align="center" class="style3">FROM</p>
      ...
      <td width="242"><p align="center" class="style3">TO</p>
      <p align="center">
    ...
    <tr>
      <td colspan="2"><div align="center"><span class="style3">PLANT ID</span>  
          <select name="PLN" id="PLN">
