...
$sql3="select max(Complaint_Entry_Id) from complaint" ;
$res3=mysql_query($sql3) or die(mysql_error());
$rem3=mysql_fetch_array($res3);

$sql12="select * from comp_det" ;
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="PlantComplaint2.php" enctype="multipart/form-data">
				  <table width="770" border="1">
    <tr>
      <td colspan="4"><div align="center" class="style2">Employee Attendance </div></td>
    </tr>
    <tr>
      <td width="177"><span class="style4">Auto Gen Id </span></td>
      <td width="292"><input name="T1" type="text" id="T1" value="<?php echo $num ?>" required ></td>
      <td width="86" rowspan="3"><span class="style4">Plant Address </span></td>
      <td width="187" rowspan="3"><textarea name="T6" id="T6"><?php echo $rem[5] ?> </textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="29"><strong>Meter Reader Name </strong></td>
    ...
    <tr>
      <td><div align="center"><strong>Complaint</strong></div></td>
      <td><div align="center">
        <select name="COMP" id="COMP">
		 <?php  while($rem12=mysql_fetch_array($res12)) 
		             { ?>
						  <option><?php echo "$rem12[1]";?></option>
			  <?php } ?>
        </select>
      </div></td>
