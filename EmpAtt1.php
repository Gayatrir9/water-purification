...
$sql2="select * from shudha_reg where Emp_no = $rem1[0] ";
$res2=mysql_query($sql2) or die(mysql_error()); 
$rem2=mysql_fetch_array($res2);


$sql3="select max(Attend_Id) from tbl_attend_leave";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="EmpAtt2.php" enctype="multipart/form-data">
				  <table width="658" border="1">
    <tr>
      <td colspan="4"><div align="center" class="style2">Employee Attendance </div></td>
    </tr>
    <tr>
      <td width="198"><span class="style2">Employee No </span></td>
      <td width="141"><input name="T1" type="text" id="T1" value="<?php echo $rem1[0] ?> "></td>
      <td width="110"><span class="style2">Name</span></td>
      <td width="181"><input name="T2" type="text" id="T2" value="<?php echo $rem1[1] ?> "></td>
    </tr>
    <tr>
      <td><span class="style2">Plant No </span></td>
      <td><input name="T3" type="text" id="T3" value="<?php echo $rem2[4] ?>"></td>
      <td><span class="style2">Designation</span></td>
      <td><input name="T4" type="text" id="T4" value="<?php echo $rem2[3] ?>"></td>
    </tr>
    <tr>
      <td><span class="style2">Auto Gen Id </span></td>
      <td><input name="T5" type="text" id="T5" value="<?php echo $num ?>" required ></td>
      <td>Date</td>
    ...
    <tr>
      <td>DESCRIPTION</td>
      <td colspan="3"><textarea name="T6" id="T6">Logged in and started working</textarea></td>
    </tr>
    <tr>
