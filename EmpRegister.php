...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-lg-6">
			<form data-toggle="validator" role="form" method="post" action="EmpRegister1.php" enctype="multipart/form-data">
				   <table width="509" border="1">
    <tr>
      <td colspan="2"><div align="center" class="style1">Employee Reristration Form </div></td>
    </tr>
    <tr>
      <td width="260"><span class="style2">Select Employee Number </span></td>
      <td width="233"><select name="empl" id="empl">
	     <?php  while($rem=mysql_fetch_array($res)) 
		             { ?>
						  <option><?php echo "$rem[1]";?></option>
			  <?php } ?>
