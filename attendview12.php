...
$employee=$_POST['se7'];
$sql="select  Emp_Id,Emp_first_name from employee_information where emp_first_name like '$employee' ";
$res=mysql_query($sql) or die(mysql_error());
$rem=mysql_fetch_array($res);
//echo $rem[0];
 //echo $rem[1];
$sql1="select Plantnoo from plant_information";
$res1=mysql_query($sql1) or die(mysql_error());
$rem1=mysql_fetch_array($res1);
//$df = '2016-05-02';

$sql2="SELECT * FROM `tbl_attend_leave` WHERE emp_num = $rem[0] and  Emp_Date >= '$df' and  Emp_Date<= '$dt' ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<form data-toggle="validator" role="form" method="post" action="" enctype="multipart/form-data">
			 <table width="799" border="1" bgcolor="#0033FF">
    <tr>
      <td colspan="4"><div align="center" class="style1">REPORT OF ATTENDENCE </div></td>
    </tr>
    <tr>
      <td width="158"><span class="style2">EMPLOYEE ID</span></td>
      <td colspan="3"><strong class="style2">EMPLOYEE NAME  </strong></td>
    </tr>
    <tr>
      <td><div align="center">
        <input name="T1" type="text" id="T1" value="<?php echo $rem[0]?>">
      </div></td>
      <td colspan="3"><input name="T2" type="text" id="T2" value="<?php echo $rem[1]?>"></td>
    </tr>
    <tr>
      <td height="29"><div align="center"><strong class="style2">PLANT NO </strong></div></td>
      <td width="144"><div align="center"><strong class="style2">DATE FROM </strong></div></td>
      <td width="144"><div align="center"><strong class="style2">DATE TO</strong></div></td>
      <td width="325">&nbsp;</td>
    </tr>
    <tr>
      <td><div align="center">
        <input name="T3" type="text" id="T3" value="<?php echo $rem1[0]?>">
      </div></td>
      <td><div align="center">
    ...
    <tr>
      <td><div align="center"><span class="style7">Ateendance No.</span></div></td>
      <td><div align="center"><span class="style7">Nature</span></div></td>
      <td colspan="2"><div align="center"><span class="style7">Description</span></div></td>
    </tr>
	 ...
	 <?php while($rem2=mysql_fetch_array($res2))
               ...
               <td colspan="2"><span class="style10"><?php echo $rem2[6]?></span></td>
			   </tr>
	      <?php }?>
