...
$eng_no = $_POST['EMP'];
$comp_det = $_POST['COMP'];
$comp_date = $_POST['se6'].'-'.$_POST['se5'].'-'.$_POST['se4'];
$stat = 1;
//STR_TO_DATE("$atda","%d-%m-%Y")
 $sql1="insert into  complaint values('$compid','$plno','$eng_no','$comp_det',STR_TO_DATE('$comp_date','%Y-%m-%d'),'','$stat' )";
