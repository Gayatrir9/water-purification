...
$sql2="SELECT * FROM `comp_solved` WHERE Complaint_Entry_Id IN (select Complaint_Entry_Id from complaint where Plant_no = '$P') and  Solve_Date >= '$df' and  Solve_Date <= '$dt' ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<table width="834" border="1" bgcolor="#0033FF">
    <tr>
      <td colspan="5"><div align="center" class="style1">REPORT OF COMPLAINT SOLVED STATUS </div></td>
    </tr>
    <tr>
      <td width="136" height="29"><div align="center"><strong class="style2">PLANT NUMBER </strong></div></td>
      <td width="155"><div align="center"><strong class="style2">DATE FROM </strong></div></td>
    ...
    <tr>
	 <td><div align="center"><span class="style7">Comp.Solve No </span></div></td>
      <td><div align="center"><span class="style7">Comp No. </span></div></td>
	  <td width="162"><div align="center"><span class="style7">Engineer Name </span></div></td>
      <td width="91">Solved Date </td>
      <td colspan="3"><div align="center"><span class="style7">Decription</span></div>        <div align="center"></div></td>
      <td colspan="2"><div align="center"><span class="style7">Status</span></div></td>
    </tr>
	 ...
	 <?php while($rem2=mysql_fetch_array($res2))
			   ...
			   <td><span class="style10"><?php echo $rem2[2]?></span></td>
               <td><span class="style10"><?php echo $rem2[3]?></span></td>
               <td colspan="3"><div align="center"><span class="style10"><?php echo $rem2[5]?></span></div>                 <div align="center"></div></td>
               <td width="67" colspan="2"><div align="center"><span class="style10"><?php echo $rem2[4]?></span></div></td>
			   </tr>
	      <?php }?>
