    ...
    <div class="container">
        ...
        <div class="row">
			...
			<form data-toggle="validator" role="form" method="post" action="" enctype="multipart/form-data">
			  <table width="713" border="1" bgcolor="#FFFFFF">
                <tr>
                  <td colspan="5"><div align="center" class="style1 style11">REPORT OF METER READING </div></td>
                </tr>
                <tr>
                  <td width="133">&nbsp;</td>
                  <td width="133"><div align="center" class="style11">PLANT NUMBER </div></td>
                  <td width="127"><div align="center" class="style11">DATE FROM </div></td>
                  <td width="144"><div align="center" class="style11">DATE TO</div></td>
                  <td width="97"><span class="style11"></span></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><span class="style11"><span class="style12">Date Of Reading</span></span></td>
                  <td colspan="4"><div align="center" class="style11"><span class="style12">Reading Done By </span></div>                    <div align="center" class="style11"></div></td>
                </tr>
                ...
                <tr class="style2">
                  ...
                  <td><span class="style13"><?php echo $rem2[5]?></span></td>
                  <td colspan="4"><span class="style13"><?php echo $rem2[2]?></span></td>
                </tr>
                <?php }?>
              </table>
			</form>
